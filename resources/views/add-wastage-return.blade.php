...
<!-- Mirrored from dashlite.net/demo7/pharmacy/add-wastage-return.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:10 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Add Wastage Return</title>
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                                    for="name">Customer</label><input type="text"
                                                    class="form-control" id="name" placeholder="Customer" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                                    for="seller">Seller</label><input type="text"
                                                    class="form-control" id="seller" placeholder="Seller" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                                    for="mail">Email</label><input type="email"
                                                    class="form-control" id="mail" placeholder="Email"></div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label" for="name">Product
                                                    Name</label><input type="text" class="form-control"
                                                    id="name" placeholder="Name" required></div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label" for="gname">Generic
                                                    Name</label><input type="text" class="form-control"
                                                    id="gname" placeholder="Generic Name" required></div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                                    for="amount">Amount</label><input type="number"
                                                    class="form-control" id="amount" placeholder="Amount" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label" for="invoice">Invoice
                                                    No</label><input type="number" class="form-control" id="invoice"
                                                    placeholder="Invoice No" required></div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label">Reason</label>
                                                <div class="form-control-wrap"><select class="form-select js-select2">
                                                        <option value="default_option">Select</option>
                                                        <option value="option_select_reason">Wrong medication
                                                        </option>
                                                        <option value="option_select_reason">Wrong dispensing
                                                        </option>
                                                        <option value="option_select_reason">Subsidence symptoms
                                                        </option>
                                                    </select></div>
                                            </div>
                                        </div>
