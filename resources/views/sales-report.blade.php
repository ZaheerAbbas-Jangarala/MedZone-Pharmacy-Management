...
<!-- Mirrored from dashlite.net/demo7/pharmacy/sales-report.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:15 GMT -->
<!-- Added by HTTrack -->
                                                            ...
                                                            <div class="card-title-group">
                                                                <div class="card-tools">
                                                                    <div class="form-control-wrap">
                                                                        <div
                                                                            class="input-daterange date-picker-range input-group">
                                                        ...
                                                        <div class="card-inner p-0">
                                                            <div class="nk-tb-list nk-tb-ulist">
                                                                <div class="nk-tb-item nk-tb-head">
                                                                    ...
                                                                    <div class="nk-tb-col"><span>Medicine Name</span>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="sub-text">Total Sales Amount</span>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-lg"><span
                                                                            class="sub-text">Categtory</span></div>
                                                                    <div class="nk-tb-col"><span>Sales Quantity</span>
                                                                    </div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Zimax</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">2000.55 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Tablet</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>100box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Oxidon</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">3200.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Tablet</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>252box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">MED-1008</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">4500.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg">
                                                                        <span>Inhealer</span></div>
                                                                    <div class="nk-tb-col"><span>552box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Ceevit</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">3400.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg">
                                                                        <span>Vitamin</span></div>
                                                                    <div class="nk-tb-col"><span>444box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    ...
                                                                                    A</span></span></a></div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">2100.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Tablet</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>230box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Pantonix</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">1200.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Tablet</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>800box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Isoniazid</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">3200.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Syrup</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>3200box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col tb-col-lg">
                                                                        <span>Vitamin</span></div>
                                                                    <div class="nk-tb-col"><span>2200box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Acetylsalicylic
                                                                                    Acid</span></span></a></div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">1000.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Syrup</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>350box</span></div>
                                                                </div>
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col nk-tb-col-check">
                                                                        <div
                                                                    ...
                                                                    <div class="nk-tb-col"><a
                                                                            href="medicine-details.html"><span
                                                                                class="tb-product"><span
                                                                                    class="title">Voltaren</span></span></a>
                                                                    </div>
                                                                    <div class="nk-tb-col tb-col-md"><span
                                                                            class="tb-amount">8766.00 <span
                                                                                class="currency">USD</span></span></div>
                                                                    <div class="nk-tb-col tb-col-lg"><span>Syrup</span>
                                                                    </div>
                                                                    <div class="nk-tb-col"><span>300box</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-inner">
            ...
            <div class="modal-content"><a href="#" class="close" data-bs-dismiss="modal"><em
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-4">
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="category">Category</label><input
                                        type="text" class="form-control" id="category" placeholder="Category"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="invoiceId">Invoice
                                        ID</label><input type="text" class="form-control" id="invoiceId"
                                        placeholder="Invoice ID"></div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="amount">Amount</label><input
                                        type="number" class="form-control" id="amount" placeholder="$100"></div>
                            </div>
                            <div class="col-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li><a href="#" data-bs-dismiss="modal" class="btn btn-primary">Add Income</a></li>
