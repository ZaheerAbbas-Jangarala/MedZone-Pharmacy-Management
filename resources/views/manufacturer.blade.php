...
<!-- Mirrored from dashlite.net/demo7/pharmacy/manufacturer.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:10 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="nk-content-body">
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                ...
                                <div class="nk-block-head-content"><a data-bs-toggle="modal" href="#addManufacture"
                                        class="btn btn-icon btn-primary d-md-none"><em
                                            class="icon ni ni-plus"></em></a><a data-bs-toggle="modal"
                                        href="#addManufacture" class="btn btn-primary d-none d-md-inline-flex"><em
                                            class="icon ni ni-plus"></em><span>Add Manufacturer</span></a></div>
                            </div>
                        </div>
                        <div class="nk-block">
                                        ...
                                        <div class="card-search search-wrap" data-search="search">
                                            <div class="card-body">
                                                <div class="search-content"><a href="#"
                                                        ...
                                                        placeholder="Search by  manufacturer id"><button
                                    ...
                                    <div class="card-inner p-0">
                                        <div class="nk-tb-list nk-tb-ulist">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Manufacturer
                                                        ID</span></div>
                                                <div class="nk-tb-col"><span class="sub-text">Company</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Phone</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg"><span class="sub-text">Address</span>
                                                </div>
                                                <div class="nk-tb-col"><span class="sub-text">Balance</span>
                                                </div>
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-35</span></a></div>
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : Toronto</span></div>
                                                    <div><span>State : Ontario</span></div>
                                                    <div><span>Country : Canada</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">7868.55 <span
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-56</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : Florida</span></div>
                                                    <div><span>State : Lake Buena Vista</span></div>
                                                    <div><span>Country : United States</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">9047.20 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-98</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : Montogmery</span></div>
                                                    <div><span>State : Albama</span></div>
                                                    <div><span>Country :USA</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">4300.98 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-success">Active</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-89</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                                    class="tb-lead">Sun</span><span>Sun@.com</span>
                                                            </div>
                                                        </div>
                                                    </a></div>
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : USA</span></div>
                                                    <div><span>State : California</span></div>
                                                    <div><span>Country : Los Angeles</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">8085.26 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-success">Active</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-65</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : Toronto</span></div>
                                                    <div><span>State : Onatario</span></div>
                                                    <div><span>Country : Canada</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">1200.20 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-warning">Inactive</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-79</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : Seoul</span></div>
                                                    <div><span>State : Corea</span></div>
                                                    <div><span>Country :South Corea</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">4576.00 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-success">Active</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-21</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col"><span class="tb-amount">25054.00 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-warning">Inactive</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-63</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <div><span>City : Seoul</span></div>
                                                    <div><span>State : Seoul</span></div>
                                                    <div><span>Country : South Corea</span></div>
                                                </div>
                                                <div class="nk-tb-col"><span class="tb-amount">6065.35 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-success">Active</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-58</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-info"><span
                                                ...
                                                <div class="nk-tb-col"><span class="tb-amount">225.50 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-success">Active</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#M-78</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col"><span class="tb-amount">3523.55 <span
                                                            class="currency">USD</span></span></div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="tb-status text-warning">Inactive</span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
