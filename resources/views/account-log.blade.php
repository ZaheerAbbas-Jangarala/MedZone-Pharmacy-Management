        ...
        <div class="nk-sidebar" data-content="sidebarMenu">
            <div class="nk-sidebar-bar">
                <div class="nk-apps-brand"><a href="../index-2.html" class="logo-link"><img class="logo-light logo-img"
                            src="../images/logo-small.png" srcset="/demo7/images/logo-small2x.png 2x"
                            ...
                            <div class="nk-sidebar-menu">
                                <ul class="nk-menu apps-menu">
                                    <li class="nk-menu-item active"><a href="#"
                                            class="nk-menu-link nk-menu-switch" data-target="navPharmacy"><span
                                                class="nk-menu-icon"><em class="icon ni ni-capsule"></em></span></a>
                                    </li>
                            ...
                            <div class="nk-sidebar-footer">
                                <ul class="nk-menu nk-menu-md apps-menu">
                                    <li class="nk-menu-item"><a href="#" class="nk-menu-link"
                                            title="Settings"><span class="nk-menu-icon"><em
                ...
                <div class="nk-sidebar-inner" data-simplebar>
                        ...
                        <ul class="nk-menu">
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="customer-ledger.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Customer Ledger</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="medicine-details.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Medicine
                                                Details</span></a></li>
                                </ul>
                            </li>
                            <li class="nk-menu-item has-sub"><a href="#"
                    ...
                    <div class="nk-menu-content" data-content="navHospital">
                        ...
                        <ul class="nk-menu">
                            <li class="nk-menu-item"><a href="../hospital/index.html" class="nk-menu-link"><span
                                        class="nk-menu-icon"><em class="icon ni ni-dashboard-fill"></em></span><span
                                        class="nk-menu-text">Dashboard</span></a></li>
                            <li class="nk-menu-item"><a href="../hospital/appointment.html"
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="../hospital/patient-add.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Add Patient</span></a>
                                    </li>
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="../hospital/doctor-nurse-list.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Doctors /
                                                Nurses</span></a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="../hospital/birth-report.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Birth Report</span></a>
                                    </li>
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                    class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em
                                            class="icon ni ni-panel-fill"></em></span><span class="nk-menu-text">Misc
                                        Pages</span></a>
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="../hospital/death-report.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Death Report</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nk-menu-item"><a href="../hospital/user-profile.html"
                                    class="nk-menu-link"><span class="nk-menu-icon"><em
                                            class="icon ni ni-user-fill"></em></span><span class="nk-menu-text">User
                                        Profile</span></a></li>
                    ...
                    <div class="nk-menu-content" data-content="navPages">
                        ...
                        <ul class="nk-menu">
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="../project-card.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Project Cards</span></a>
                                    </li>
                                    <li class="nk-menu-item"><a href="../project-list.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Project List</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nk-menu-item has-sub"><a href="#"
                                    class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em
                                            class="icon ni ni-users-fill"></em></span><span class="nk-menu-text">User
                                        Manage</span></a>
                                <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="../orders-regular.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Order List -
                                                Regular</span></a></li>
                                    <li class="nk-menu-item"><a href="../orders-sales.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Order List -
                                                Sales</span></a></li>
                                    <li class="nk-menu-item"><a href="../invoice-list.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Invoices List</span></a>
                                    </li>
                                    <li class="nk-menu-item"><a href="../invoice-details.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Invoice Details</span></a>
                                    </li>
                    ...
                    <div class="nk-menu-content" data-content="navMisc">
                        ...
                        <ul class="nk-menu">
                            ...
                            <li class="nk-menu-item no-icon"><a href="#"
                                    class="nk-menu-link nk-menu-toggle"><span class="nk-menu-text">Classic Version -
                                        v2</span></a>
                                <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item no-icon"><a href="#"
                                    class="nk-menu-link nk-menu-toggle"><span class="nk-menu-text">No Slider Version -
                                        v3</span></a>
                                <ul class="nk-menu-sub">
                    ...
                    <div class="nk-menu-content" data-content="navComponents">
                        ...
                        <ul class="nk-menu">
                            <li class="nk-menu-item has-sub"><a href="#"
                                    class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em
                                            class="icon ni ni-layers-fill"></em></span><span class="nk-menu-text">Ui
                                        Elements</span></a>
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="#"
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item"><a
                                                    href="../components/elements/util-display.html"
                                                    class="nk-menu-link"><span class="nk-menu-text">Display</span></a>
                                            </li>
                                            <li class="nk-menu-item"><a
                                                    href="../components/elements/util-embeded.html"
                                            ...
                                            <li class="nk-menu-item"><a
                                                    href="../components/elements/util-spacing.html"
                            ...
                            <li class="nk-menu-item"><a href="../components/misc/icons.html"
                                    class="nk-menu-link"><span class="nk-menu-icon"><em
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item"><a href="../components/tables/table-basic.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Basic Tables</span></a>
                                    </li>
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="../components/forms/number-spinner.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Number Spinner</span>
                                            <span class="nk-menu-badge badge-warning">New</span></a></li>
                                    <li class="nk-menu-item"><a href="../components/forms/form-layouts.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Form Layouts</span></a>
                                    </li>
                                    ...
                                    <li class="nk-menu-item"><a href="../components/forms/form-wizard.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Wizard Basic</span></a>
                                    </li>
                                    <li class="nk-menu-item"><a href="#"
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item"><a
                                                    href="../components/forms/form-summernote.html"
                            ...
                            <li class="nk-menu-item has-sub"><a href="#"
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="../components/misc/sweet-alert.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Sweet Alert</span></a>
                                    </li>
                                    ...
                                    <li class="dropdown chats-dropdown hide-mb-xs"><a href="#"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                            <div class="dropdown-head"><span
                                                    class="sub-title nk-dropdown-title">Recent
                                                    ...
                                                    <div class="nk-block-between">
                                                        <div class="nk-block-head-content">
                                                            ...
                                                            <div class="nk-block-des">
                                                                <p>Here is your last 20 login activities log. <span
                                                                        class="text-soft"><em
                                                                            class="icon ni ni-info text-danger"></em></span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <table class="table table-ulogs">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                <th class="tb-col-os"><span
                                                                        class="overline-title">Browser <span
                                                                            class="d-sm-none">/ IP</span></span></th>
                                                                <th class="tb-col-ip"><span
                                                                        class="overline-title">IP</span></th>
                                                                <th class="tb-col-time"><span
                                                                        class="overline-title">Time</span></th>
                                                                <th class="tb-col-time"><span
                                                                        class="overline-title">Activity</span></th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text">11:34
                                                                        PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span
                                                                            class="badge bg-danger ms-0">Deleted</span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text">11:34
                                                                        PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span
                                                                            class="badge bg-success ms-0">Updated</span>
                                                                <td class="tb-col-action"><a href="#"
                                                                        class="link-cross me-sm-n1"><em
                                                                            class="icon ni ni-cross"></em></a></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text">11:34
                                                                        PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span
                                                                            class="badge bg-primary ms-0">Created</span>
                                                                <td class="tb-col-action"><a href="#"
                                                                        class="link-cross me-sm-n1"><em
                                                                            class="icon ni ni-cross"></em></a></td>
                                                            </tr>
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu">
                                                            <li><a href="general-settings.html"><em
                                                                        class="icon ni ni-setting-alt-fill"></em><span>General</span></a>
                                                            </li>
                                                            <li><a href="member-settings.html"><em
                                                                        class="icon ni ni-account-setting"></em><span>Members</span></a>
                                                            </li>
                                                            <li><a href="email-settings.html"><em
                                                                        class="icon ni ni-lock-alt-fill"></em><span>E-mail</span></a>
                                                            </li>
                                                            <li><a href="security-settings.html"><em
                                                                        class="icon ni ni-shield-star-fill"></em><span>Security</span></a>
                                                            </li>
                                                            <li><a class="active"
                                                                    href="../hospital/account-log.html"><em
        ...
        <div class="nk-demo-list" data-simplebar>
            ...
            <div class="nk-demo-item"><a href="index.html">
                    <div class="nk-demo-image bg-warning"><img src="../../images/landing/demo-pharmacy.jpg"
                            srcset="https://dashlite.net/images/landing/demo-pharmacy2x.jpg 2x" alt="pharmacy">
                    </div>
            ...
            <div class="nk-demo-item"><a href="https://dashlite.net/demo5/loan/index.html">
                    <div class="nk-demo-image bg-purple"><img src="../../images/landing/demo-loan.jpg"
                            srcset="https://dashlite.net/images/landing/demo-loan2x.jpg 2x" alt="loan"></div>
...
<!-- Mirrored from dashlite.net/demo7/pharmacy/account-log.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:28:17 GMT -->
