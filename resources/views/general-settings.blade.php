...
<!-- Mirrored from dashlite.net/demo7/pharmacy/general-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:15 GMT -->
<!-- Added by HTTrack -->
                                        ...
                                        <div class="nk-block-head nk-block-head-lg">
                                            <div class="nk-block-between">
                                                <div class="nk-block-head-content">
                                                    <h5 class="title fw-medium">General settings</h5><span>These
                                                        settings helps you modify site settings.</span>
                                                </div>
                                        ...
                                        <div class="nk-block">
                                            <form action="#" class="form-settings gy-3">
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label"
                                                                for="site-name">pharmacy Name</label><span
                                                ...
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label"
                                                                for="site-email">pharmacy Address</label><span
                                                                class="form-note">Specify the key of your
                                                                pharmacy address</span></div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap"><input type="text"
                                                                    class="form-control" id="site-email"
                                                                    value="Softnio Street 3"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label"
                                                                for="site-copyright">Copyright</label><span
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap"><input type="text"
                                                                    class="form-control" id="site-copyright"
                                                                    value="&copy; 2019, DashLite. All Rights Reserved.">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label">Allow
                                                                Registration</label><span class="form-note">Enable or
                                                        ...
                                                        <ul class="custom-control-group g-3 align-center flex-wrap">
                                                            <li>
                                                                <div class="custom-control custom-radio"><input
                                                                        ...
                                                                        checked name="reg-public" id="reg-enable"><label
                                                                        class="custom-control-label"
                                                                        for="reg-enable">Enable</label></div>
                                                            </li>
                                                            <li>
                                                                <div class="custom-control custom-radio"><input
                                                                        type="radio" class="custom-control-input"
                                                                        name="reg-public" id="reg-disable"><label
                                                                        class="custom-control-label"
                                                                        for="reg-disable">Disable</label></div>
                                                            </li>
                                                            <li>
                                                                <div class="custom-control custom-radio"><input
                                                                        type="radio" class="custom-control-input"
                                                                        name="reg-public" id="reg-request"><label
                                                                        class="custom-control-label"
                                                ...
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label">Main
                                                                Site</label><span class="form-note">Specify the
                                                                URL if your main website is external.</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                ...
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label"
                                                                for="site-name"> Description</label><span
                                                                class="form-note">Describe your pharmacy
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap">
                                                                <div class="form-control-wrap">
                                                                    <textarea class="form-control form-control no-resize" id="fv-message" name="fv-message" placeholder="Hello World!">                                                 </textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row g-3 align-center">
                                                    <div class="col-lg-5">
                                                        <div class="form-group"><label class="form-label"
                                                                ...
                                                                class="form-note">Enable to make Project make
                                                                offline.</span></div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="form-group">
                                        ...
                                        <div class="card-inner-group" data-simplebar>
                                            ...
                                            <div class="card-inner p-0">
                                                <ul class="link-list-menu">
                                                    <li><a class="active" href="general-settings.html"><em
...
<!-- Mirrored from dashlite.net/demo7/pharmacy/general-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:16 GMT -->
