...
<!-- Mirrored from dashlite.net/demo7/pharmacy/add-manufacturer-return.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:10 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Add Manufacturer Return</title>
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                                    for="name">Company</label><input type="text"
                                                    class="form-control" id="name" placeholder="Company" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div class="form-group"><label class="form-label"
                                                    for="phone">Phone</label><input type="phone"
