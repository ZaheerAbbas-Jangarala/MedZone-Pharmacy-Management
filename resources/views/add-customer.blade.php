...
<!-- Mirrored from dashlite.net/demo7/pharmacy/add-customer.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:08 GMT -->
<!-- Added by HTTrack -->
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            id="item" placeholder="item" required>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                            for="name">Amount</label><input type="number"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group"><button type="submit"
                                                            class="btn btn-primary">Add Customer</button></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Mirrored from dashlite.net/demo7/pharmacy/add-customer.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:09 GMT -->
