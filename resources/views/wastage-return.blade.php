...
<!-- Mirrored from dashlite.net/demo7/pharmacy/wastage-return.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:27:10 GMT -->
<!-- Added by HTTrack -->
                                    ...
                                    <div class="toggle-wrap nk-block-tools-toggle"><a href="#"
                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-2">
                                                ...
                                                <li class="nk-block-tools-opt"><a href="add-wastage-return.html"
                                                        class="btn btn-icon btn-primary d-md-none"><em
                                                            class="icon ni ni-plus"></em></a><a
                                                        href="add-wastage-return.html"
                                                        class="btn btn-primary d-none d-md-inline-flex"><em
                                                            class="icon ni ni-plus"></em><span>Add Wastage
                                                            Return</span></a></li>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="card-search search-wrap" data-search="search">
                                            <div class="card-body">
                                                <div class="search-content"><a href="#"
                                                        ...
                                                        placeholder="Search by Purchase id name or"><button
                                    ...
                                    <div class="card-inner p-0">
                                        <div class="nk-tb-list nk-tb-ulist">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Purchase
                                                        ID</span></div>
                                                <div class="nk-tb-col"><span class="sub-text">Customer</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg"><span class="sub-text">Date</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl"><span class="sub-text">Product
                                                        Details</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span class="sub-text">Seller</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Reason</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl"><span
                                                        class="sub-text">Quantity</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-mb"><span class="sub-text">Amount</span>
                                                </div>
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#3587</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            <div class="user-avatar bg-success"><span>AB</span>
                                                            </div>
                                                ...
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">Zimax</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Azithromycin</span></div>
                                                    <div><span>Catagory : Tablet</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#746f5k2</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Anim
                                                                Lio</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-danger">Wrong medication</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl"><span>2box</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">78.55
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#7684</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">Oxidon</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Domperidon</span></div>
                                                    <div><span>Catagory : Tablet</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#75635k9</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Robert
                                                                Omi</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-warning">Wrong
                                                        dispensing</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span>10pcs</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">90.20
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#3466</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-lg"><span>05/12/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">MED-1008</span></span>
                                                    </div>
                                                    <div><span>Generic Name : hydrazine</span></div>
                                                    <div><span>Catagory : Inhealer</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#546H74W</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Jon
                                                                Nurb</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-info">Subsidence
                                                        symptoms</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span>5pcs</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">43.98
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#6523</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-lg"><span>02/08/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">Ceevit</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Vitamin C</span></div>
                                                    <div><span>Catagory : Vitamin</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#87X6A44</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Jimi
                                                                Tarde</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                ...
                                                <div class="nk-tb-col tb-col-xxl"><span>4pcs</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">80.26
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#1274</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info"><span class="tb-lead">Frances
                                                                    Burns
                                                                </span><span>frances@example.com</span></div>
                                                        </div>
                                                    </a></div>
                                                <div class="nk-tb-col tb-col-lg"><span>09/02/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">DON A</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Domperidon</span></div>
                                                    <div><span>Catagory : Tablet</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#986G531</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Janet
                                                                Snyder</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-warning">Wrong
                                                        dispensing</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span>9pcs</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">12.20
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#8134</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info"><span class="tb-lead">Alan
                                                                    Butler
                                                                </span><span>butler@example.com</span></div>
                                                        </div>
                                                    </a></div>
                                                <div class="nk-tb-col tb-col-lg"><span>20/01/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">Pantonix</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Pantoprazol</span></div>
                                                    <div><span>Catagory : Tablet</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#326T4M9</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Sturn
                                                                Vais</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-info">Subsidence of
                                                        symptoms</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span>1box</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">45.00
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#9124</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info"><span class="tb-lead">Victoria
                                                                    Lynch
                                                                </span><span>victoria@example.com</span></div>
                                                        </div>
                                                    </a></div>
                                                <div class="nk-tb-col tb-col-lg"><span>03/05/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">Iconiazid</span></span>
                                                    </div>
                                                    <div><span>Generic Name : hydrazine</span></div>
                                                    <div><span>Catagory : Syrup</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#87Z6A44</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Born
                                                                Myre</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-warning">Wrong
                                                        dispensing</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span>2bottle</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">250.00
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#8264</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-lg"><span>07/05/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">EC
                                                                Plus</span></span></div>
                                                    <div><span>Generic Name : Vitamin E</span></div>
                                                    <div><span>Catagory : Vitamin</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#746F5K2</span></span>
                                                    </div>
                                                ...
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Runi
                                                                Lara</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                ...
                                                <div class="nk-tb-col tb-col-xxl"><span>5pcs</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">60.35
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#8125</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-lg"><span>19/08/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span
                                                                class="fw-bold">Acetylsalicylic</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Aspirin</span></div>
                                                    <div><span>Catagory : Syrup</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#685HFM1</span></span>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><span
                                                        class="badge  bg-outline-info">Subsidence
                                                        symptoms</span></div>
                                                <div class="nk-tb-col tb-col-xxl"><span>3bottle</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">25.50
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                                            ...
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md"><a href="#"><span
                                                            class="fw-medium">#8123</span></a></div>
                                                <div class="nk-tb-col"><a href="#">
                                                        <div class="user-card">
                                                ...
                                                <div class="nk-tb-col tb-col-lg"><span>29/07/2021</span></div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div><span>Name : <span class="fw-bold">voltaren</span></span>
                                                    </div>
                                                    <div><span>Generic Name : Diclofenac</span></div>
                                                    <div><span>Catagory : Syrup</span></div>
                                                    <div><span>Invoice : <span
                                                                class="text-success">#2385L1</span></span></div>
                                                </div>
                                                <div class="nk-tb-col tb-col-xxl">
                                                    <div class="user-card">
                                                        <div class="user-avatar sm bg-success-dim"><em
                                                                class="icon ni ni-user-fill"></em></div>
                                                        <div class="user-name"><span class="tb-lead">Sparking
                                                                Piom</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-col tb-col-md"><span
                                                ...
                                                <div class="nk-tb-col tb-col-xxl"><span>1bottle</span></div>
                                                <div class="nk-tb-col tb-col-mb"><span class="tb-amount">33.55
                                                        <span class="currency">USD</span></span></div>
                                                <div class="nk-tb-col nk-tb-col-tools">
                                                    <ul class="nk-tb-actions gx-1">
                                                        <li class="nk-tb-action-hidden"><a href="#"
                        ...
                        <div class="row g-gs">
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="customer">Customer</label><input type="text" class="form-control"
                                        id="customer" placeholder="Customer" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="seller">Seller</label><input
                                        type="text" class="form-control" id="seller" placeholder="Seller"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="name">Product
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="amount">Amount</label><input
                                        type="number" class="form-control" id="amount" placeholder="Amount"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label" for="invoice">Invoice
                                        No</label><input type="text" class="form-control" id="invoice"
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label"
                                        for="quantity">Quantity</label><input type="number" class="form-control"
                                        id="quantity" placeholder="Quantity" required></div>
                            </div>
                            <div class="col-md-6">
