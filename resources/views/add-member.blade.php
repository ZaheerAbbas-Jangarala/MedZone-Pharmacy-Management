...
<!-- Mirrored from dashlite.net/demo7/pharmacy/add-member.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 16:28:17 GMT -->
<!-- Added by HTTrack -->
                                    ...
                                    <div class="card card-bordered">
                                        <div class="card-inner">
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label">Date of
                                                            Birth</label>
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            class="form-control" id="phone-no" placeholder="Phone no">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                            for="email">Email</label><input type="email"
                                                            class="form-control" id="email" placeholder="Email"></div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label
                                                            class="form-label">Adddress</label><input type="text"
                                                            class="form-control" id="address" placeholder="Address">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label" for="photo">Upload
                                                            Photo</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file"><input type="file" multiple
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label
                                                        ...
                                                        <div class="form-control-wrap"><select
                                                                ...
                                                                <option value="option_select_designation">Manager
                                                                </option>
                                                                <option value="option_select_designation">Pharmacist
                                                                </option>
                                                                <option value="option_select_designation">Accountant
                                                                </option>
                                                                <option value="option_select_designation">Salesman
                                                                </option>
                                                                <option value="option_select_designation">Cleaner
                                                                </option>
                                                            </select></div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                            for="nidLabel">National ID</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file"><input type="file" multiple
                                                                    class="form-control" id="nid"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label"
                                                            for="certificatesLabel">Certificates</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file"><input type="file" multiple
                                                                    class="form-control" id="certificates"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group"><label class="form-label">Joining
                                                            Date</label>
                                                        <div class="form-control-wrap">
                                                            <div class="form-icon form-icon-right"><em
                                                                    class="icon ni ni-calendar"></em></div><input
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group"><label class="form-label" for="bio">Short
                                                            Biography</label>
                                                        <div class="form-control-wrap">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group"><button type="submit"
                                                            class="btn btn-primary">Add Member</button></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
